...
```
GET https://www.emploi.ma/                          403, 25 B, md5 9ccabba20b9f    (12:22:54Z)
GET https://www.emploi.ma/                          403, 25 B, md5 9ccabba20b9f    (second fetch)
GET https://www.emploi.ma/recherche-jobs-maroc     403, 25 B, md5 9ccabba20b9f    (12:24:59Z)
GET https://www.emploi.ma/recherche-jobs-maroc     403, 25 B, md5 9ccabba20b9f    (second fetch)
```
...
- **No script, no configuration.** A user with a URL from this host can hand
  ...
  established here.
- **AfricaWork franchise** (the same 1 836-byte managed block) and the static default — **one read of this host, dated**, not a verdict copied from a sibling.
